...
<title>車検費用が驚きの3万円台から！とことん車検ナビで車検予約</title>
...
<!--▼section-->
  <section>
    <div class="title_search">
        <h3><span><img src="http://<?= $_SERVER['HTTP_HOST'] ?>/sp/images/common/title_icon.png" width="20" height="12"></span>エリアから車検を探す</h3>
    </div>
    <div class="area_left">
    <dl class="acordion">
        <dt class="trigger" id="about_icon"><span class="open-close">北海道・東北</span></dt>
        ...
        <dl class="acordion">
        <dt class="trigger" id="about_icon"><span class="open-close">北陸・甲信越</span></dt>
        <dd class="acordion_tree clear">
            <ul>
        ...
        <dl class="acordion">
        <dt class="trigger" id="about_icon"><span class="open-close">近畿</span></dt>
        <dd class="acordion_tree clear">
            <ul>
        ...
        <dl class="acordion">
        <dt class="trigger" id="about_icon"><span class="open-close">九州・沖縄</span></dt>
        <dd class="acordion_tree clear">
            <ul>
    ...
    <div class="area_right">
        <dl class="acordion">
        <dt class="trigger" id="about_icon"><span class="open-close">関東</span></dt>
        <dd class="acordion_tree clear">
            <ul>
        ...
        <dl class="acordion">
        <dt class="trigger" id="about_icon"><span class="open-close">東海</span></dt>
        <dd class="acordion_tree clear">
            <ul>
        ...
        <dl class="acordion">
        <dt class="trigger" id="about_icon"><span class="open-close">中国・四国</span></dt>
        <dd class="acordion_tree clear">
            <ul>
...
<!--▼現在の注文状況-->
    ...
    <div class="title03">
    <h3><span><img src="images/common/title_icon.png" width="20" height="12"></span>お見積りご注文状況</h3>
  </div>
    <div class="innner">
    <p>全国からお見積りご注文を頂いております！</p>
