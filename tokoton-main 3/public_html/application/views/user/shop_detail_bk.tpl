...
<div id="content">
	<ul id="breadcrumb">
		<li><a href="/">全国の車検費用比較サイト【とことん車検ナビ】ホーム</a></li>
		<li><a href="/search_top/">車検をさがす</a></li>
		<li><a href="{if $search_url ne ""}{$search_url}{else}/search/index/{/if}">検索結果</a></li>
		<li><h2 id="searchword_breadcrumb">{$shop_data.sd_shop_nm}</h2></li>
	</ul>
	<br class="clear"/>
	<div class="ninja_onebutton margin_top10">
		...
		<div id="content_all">
			<div id="content_left">
				...
				<br class="clear" />
				<h3 id="contents">対応サービス</h3>
				{if $option_data.flag == "t"}
					<ul id="icon">
						{if $option_data.icon1 == "t"}
						<!--            <li><img src="/img/user/detail/icon_1.gif" alt="とことん24取扱い" width="45" height="66" /></li>-->
						{/if}
						{if $option_data.icon2 == "t"}
						<li><img src="/img/user/detail/icon_2.gif" alt="整備保証付き" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon16 == "t"}
						<li><img src="/img/user/detail/icon_15.gif" alt="ロードサービス取扱い" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon15 == "t"}
						<li><img src="/img/user/detail/icon_16.gif" alt="即日完了ＯＫ" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon3 == "t"}
						<li><img src="/img/user/detail/icon_3.gif" alt="夜間受付ＯＫ" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon4 == "t"}
						<li><img src="/img/user/detail/icon_4.gif" alt="土日対応ＯＫ" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon5 == "t"}
						<li><img src="/img/user/detail/icon_5.gif" alt="代車あり" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon6 == "t"}
						<li><img src="/img/user/detail/icon_6.gif" alt="引取納車ＯＫ" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon7 == "t"}
						<li><img src="/img/user/detail/icon_7.gif" alt="キャッシュレスＯＫ" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon8 == "t"}
						<li><img src="/img/user/detail/icon_8.gif" alt="クレジットカード利用ＯＫ" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon9 == "t"}
						<li><img src="/img/user/detail/icon_9.gif" alt="グルメプレゼント" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon10 == "t"}
						<li><img src="/img/user/detail/icon_10.gif" alt="グッズプレゼント" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon11 == "t"}
						<li><img src="/img/user/detail/icon_11.gif" alt="ガソリンプレゼント" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon12 == "t"}
						<li><img src="/img/user/detail/icon_12.gif" alt="抽選でプレゼント" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon13 == "t"}
						<li><img src="/img/user/detail/icon_13.gif" alt="オイル交換サービス" width="45" height="66" /></li>
						{/if}
						{if $option_data.icon14 == "t"}
						<li><img src="/img/user/detail/icon_14.gif" alt="車検時限定割引サービス" width="45" height="66" /></li>
						{/if}
					</ul>
				{/if}
				<br class="clear" />  
				...
				<table class="top" width="600" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="340" valign="top">
							...
							<dl class="pic2">
								<dt>{if $intro2_img != ""}<img src="{$intro2_img}" alt="{$shop_data.sd_small_img01}" width="160" />{else}<img src="/img/user/detail/img_small.gif" alt="" width="160" class="noimage" />{/if}</dt>
								<dd><span style="font-size:10px;">{if $shop_data.sd_small_img01 != ""}{$shop_data.sd_small_img01}{else}&nbsp;{/if}</span></dd>
							</dl>
							<dl class="pic2">
								<dt>{if $intro3_img != ""}<img src="{$intro3_img}" alt="{$shop_data.sd_small_img02}" width="160" />{else}<img src="/img/user/detail/img_small.gif" alt="" width="160" class="noimage" />{/if}</dt>
						...
						<td width="260" valign="top">
							...
							{if $map_flag ne "f"}{if $map != ""}<div>{$map}</div><font size="-2"><a href="http://maps.google.co.jp/?mapf=q&hl=ja&geocode=&q={$shop_data.sd_shop_address|urlencode}" target="_blank">大きな地図で見る</a></font><br />{else}&nbsp;{/if}{else}&nbsp;<a href="http://maps.google.co.jp/?mapf=q&hl=ja&geocode=&q={$shop_data.sd_shop_address|urlencode}" target="_blank">Googleマップ</a>のページからご確認ください。{/if}
				...
				{if $plan != null}
					<ul id="plan_navi">
						{foreach from=$plan item = "item" key = "key" name = "plan_name_loop"}
						<li{if $smarty.foreach.plan_name_loop.last} id="none"{/if}><a href="#p{$item.pb_no}">{$item.pb_plan_nm}</a></li>
						{/foreach}
					</ul>
				{/if}
				<br class="clear" />
				{foreach from=$plan item = "item" key = "key" name = "plan_loop"}
					...
					<div class="plan_detail">
						...
						{if 1 == 2}
							<table class="plan_price" width="100%" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td align="left" class="price_title">
										<strong>軽自動車</strong><br />
										ワゴンR、ライフ、ムーブなど（軽自動車）
									</td>
									<td align="left" class="price_title">
										<strong>小型乗用車</strong><br />
										ヴィッツ、フィット、マーチなど（1.0t以下）
									</td>
									<td align="left" class="price_title">
										<strong>中型乗用車</strong><br />
										カローラ、スカイライン、アテンザなど（1.5t以下）
									</td>
									<td align="left" class="price_title">
										<strong>大型乗用車</strong><br />
										クラウン、セルシオ、マークXなど（1.5t超2.0t以下）
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="serviceprice"><font size="+1">{if $item.mini_disc_price != ""}{$item.mini_disc_price|number_format}円{else}&nbsp;{/if}</font></td>
									<td class="serviceprice"><font size="+1">{if $item.small_disc_price != ""}{$item.small_disc_price|number_format}円{else}&nbsp;{/if}</font></td>
									<td class="serviceprice"><font size="+1">{if $item.middle_disc_price != ""}{$item.middle_disc_price|number_format}円{else}&nbsp;{/if}</font></td>
									<td class="serviceprice"><font size="+1">{if $item.large_disc_price != ""}{$item.large_disc_price|number_format}円{else}&nbsp;{/if}</font></td>
								</tr>
							</table>
						{/if}
						<table class="plan_price" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								<td colspan="2"><strong>クラス</strong><br />
								（車両重量）</td>
								<td align="center"><strong>軽自動車</strong><br />
								<img src="/img/user/detail/kei.jpg" width="58" height="35" /><br />
								（軽自動車）</td>
								<td align="center"><strong>小型乗用車</strong><br />
								<img src="/img/user/detail/kogata.jpg" width="61" height="35" /><br />
								（1.0t以下）</td>
								<td align="center"><strong>中型乗用車</strong><br />
								<img src="/img/user/detail/tyuugata.jpg" width="61" height="35" /><br />
								（1.5t以下）</td>
								<td align="center"><strong>大型乗用車</strong><br />
								<img src="/img/user/detail/oogata.jpg" width="61" height="35" /><br />
								（1.5t超2.0t以下）</td>
							</tr>
							<tr>
								<td rowspan="3" class="price_title">法定<br />
								費用</td>
							...
							<tr>
								<td height="35" class="price_title">自賠責</td>
						...
						{if 1 == 2}
							(*)車検費用合計には、各種法定費用（重量税・自賠責保険料・印紙代等）が含まれています。<br class="clear" />
						{/if}
				...
				<table id="shopdata" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="value">
							...
							<ul id="card">
							{if $card_arr.card1 == "t"}
							<li><img src="/img/user/detail/visa.gif" alt="VISA" /></li>
							{/if}
							{if $card_arr.card2 == "t"}
							<li><img src="/img/user/detail/master.gif" alt="MasterCard" /></li>
							{/if}
							{if $card_arr.card3 == "t"}
							<li><img src="/img/user/detail/jcb.gif" alt="JCB" /></li>
							{/if}
							{if $card_arr.card4 == "t"}
							<li><img src="/img/user/detail/dc.gif" alt="DC" /></li>
							{/if}
							{if $card_arr.card5 == "t"}
							<li><img src="/img/user/detail/ae.gif" alt="AMERICANEXPRESS" /></li>
							{/if}
							{if $card_arr.card6 == "t"}
							<li><img src="/img/user/detail/uc.gif" alt="uc" /></li>
							{/if}
							{if $card_arr.card7 == "t"}
							<li><img src="/img/user/detail/nicos.gif" alt="Nicos" /></li>
							{/if}
							{if $card_arr.card8 == "t"}
							<li><img src="/img/user/detail/diners.gif" alt="Diners" /></li>
							{/if}
							{if $card_arr.card9 == "t"}
							<li><img src="/img/user/detail/other.gif" alt="その他" /></li>
							{/if}
							</ul>
							{else}
							&nbsp;
			...
			<div id="content_right">
				{if $coupon_flag == "t"}
					...
					<div class="right_contentbox">
						<dl id="contentdesc">
						<dt><a href="/shop_coupon/{$shop_data.sid}/{if $type != ""}{$type}/{/if}"><img src="/img/user/detail/coupon.gif" alt="お得なクーポンはこちらから" width="240" height="75" border="0" /></a></dt>
						</dl>
					</div>
				{/if}
				{if $campaign != null}
					...
					<div class="right_contentbox">
						...
						<dl id="contentdesc">
							<dt><a href="/shop_campaign/{$shop_data.sid}/{if $type != ""}{$type}/{/if}">{if $campaign_img != ""}<img src="{$campaign_img}" width="{$campaign_img_w}" height="{$campaign_img_h}" alt="" border="0" />{else}<img src="/img/user/detail/img_campaign.gif" alt="キャンペーン画像" width="240" height="135" class="noimage" border="0" />{/if}</a></dt>
							<dd>
				...
				{if $service != null}
					...
					<div class="right_contentbox">
						<dl id="contentdesc_servicelist">
						{foreach from=$service item = "item" key = "key" name = "plan_loop"}
							<dt>{$item.srv_name}</dt>
							<dd>{$item.srv_contents|nl2br}</dd>
						{/foreach}
						</dl>
					</div>
				{/if}
				{if $add_option != null}
					...
					<div class="right_contentbox">
						<dl id="contentdesc_optionlist">
						{foreach from=$add_option item = "item" key = "key" name = "plan_loop"}
							<dt>{$item.opt_name}{if $item.opt_price != ""}<br /><span class="option_price">{$item.opt_price}</span>{/if}</dt>
							<dd>{$item.opt_contents|nl2br}</dd>
						{/foreach}
						</dl>
					</div>
				{/if}
				{if $dsc_data != null}
					...
					<div class="right_contentbox">
						<ul id="contentdesc_discountlist">
						{foreach from=$dsc_data item = "item" key = "key" name = "dsc_loop"}
							<li><strong>{$item.db_menu_nm}{if $item.dd_dsc_nm != ""}[{$item.dd_dsc_nm}]{/if}</strong>▲{$item.dd_dsc_price}円</li>
						{/foreach}
					</ul>
					</div>
				{/if}
				{if $shop_data.sid == "21"}
                    <!---▼スタッフ募集中--->
                    <a href="http://www.mic-info.co.jp/adoption/index.html" target="_blank"><img src="/img/user/detail/recruit.gif" class="hover_01" /></a>
                    <!---▲スタッフ募集中--->
				{/if}
			</div>
			<br class="clear" />
		...
		<br class="clear" />
        <p><a href="http://www.tokoton-navi.com/knowledge_1.php" >←車検期間・費用等の情報はこちら</a></p>
        <p><a href="http://www.tokoton-navi.com/" >←車検費用の比較・見積もりなら【とことん車検ナビ】ホーム</a></p>
	</div>
</div>
