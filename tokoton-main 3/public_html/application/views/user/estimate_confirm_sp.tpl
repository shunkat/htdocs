{include file="ci:user/headerestimate_sp.tpl"}
	...
	<div id="form">
		...
		<table class="fm2">
          ...
          {$form_data.arrival_date}
					...
					<div style="margin-top:10px;margin-bottom:10px;color:#ff0000;">※実際の入庫日は、店舗とご相談の上決定となります。<div>
					{/if}
...
{/if}
		...
		<table id="send_edit">
			<tr>
				<td><a href="/estimate_form/{$form_data.pb_no}/"><img src="/sp/images/estimate/fixbutton.jpg" onClick="is_note_msg=false;" width="120" alt="修正する"></a></td>
				<td><a href="/user/estimate_form/sendmail/" ><img src="/sp/images/estimate/sendbutton.jpg" onClick="is_note_msg=false;" width="120" alt="送信する"></a></td>
			</tr>
		</table>
