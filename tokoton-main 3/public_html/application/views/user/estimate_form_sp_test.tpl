...
<script src="/js/check_cartype_2.js" type="text/JavaScript"></script>
	...
	{include file="$document_root/application/views/user/makerchildS.tpl"}
		...
		<div class="content_wrapp">
			...
			<ul>
				...
				<li class="subcontent" style="color:#ff0000;">※入庫希望日は仮予約のものになります。<br />店舗の状況によってお客様のご希望の日時に添えない場合がございます。</li>
	        </ul>
	        <!-- 20161205@nagai END -->
