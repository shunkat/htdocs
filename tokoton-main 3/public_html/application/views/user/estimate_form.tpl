		...
		<tbody>
			...
			<tr>
				...
				<td class="value b_s3" colspan="2">
					<span class="value">
					<input name="name" placeholder="山田太郎" type="text" size="52" value="{$form_data.name}" class="validate[required]"  onfocus = "this.style.background = '#FFFF7C';" onblur="this.style.background = '#fff';" id="name1"/>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td class="value b_s3" colspan="2">
					<span class="value">
					<input name="name_kana" placeholder="やまだたろう" type="text" size="52" value="{$form_data.name_kana}" class="validate[required]"  onfocus = "this.style.background = '#FFFF7C';" onblur="this.style.background = '#fff';" id="kana1"/>
					</span>
				</td>
			</tr>
			<tr>
				...
				<td colspan="2" class="b_s3">
					<span class="value">
					<input name="tel" placeholder=" 例：09000000000" type="text" size="52" value="{$form_data.tel}" class="validate[required]"  onfocus = "this.style.background = '#FFFF7C';" onblur="this.style.background = '#fff';" id="tel1"/>
					</span>
			...
			<tr>
				...
				<td colspan="2" class="b_s3">
					<span class="value">
					<input name="email" type="text" size="52" value="{$form_data.email}" class="validate[required,custom[email]] text-input"  onfocus = "this.style.background = '#FFFF7C';" onblur="this.style.background = '#fff';" id="mail1"/>
					</span>
				</td>
			</tr>
			<tr>
