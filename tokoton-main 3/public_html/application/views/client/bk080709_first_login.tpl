...
<div align="center">
	<div id="container">
		<div id="header"><p>とことん車検ナビ</p></div>
		...
		<div id="content">
			...
			{/if}
			<form action="/client/login/re_password" method="post">
			<table width="360" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
				<td class="td2"><strong>旧パスワード</strong>（半角英数6～12文字）      </td>
				<td class="td3"><input type="password" name="old_pwd" class="field" value="{$form.old_pwd}" /></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				<td colspan="2" class="td4"><p id="login_btn"><a href="" onclick="submit();return false;">送信</a></p></td>
			  </tr>
			</table>
