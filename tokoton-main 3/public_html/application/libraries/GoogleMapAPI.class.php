...
class GoogleMapAPI {
     ...
     * (http://maps.google.co.jp/apis/maps/signup.html)
     *
     * @var string
     */
    var $api_key = '';
	...
	var $lookup_server = array('GOOGLE' => 'maps.google.co.jp', 'YAHOO' => 'api.local.yahoo.com');
...
#        echo $this->getHeaderJS();   
    ...
    function getHeaderJS() {
        return sprintf('<script src="http://maps.google.co.jp/maps?file=api&amp;v=2&amp;key=%s" type="text/javascript" charset="utf-8"></script>', $this->api_key);
    }    
