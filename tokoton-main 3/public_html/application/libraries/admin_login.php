...
class admin_login {
	...
	var $CI;
	var $user_table = 't_manager_account';
...
#			$pwd = md5($pwd);
			...
			{	  
				...
				//Set session data
				$this->CI->session->set_userdata(array('id' => $user_id,'id' => $user));
...
#		if ($this->CI->session->userdata('id') == $user)
#		{
...
#			$this->CI->session->set_userdata($row);
			...
			//Set logged_in to true
#			$this->CI->session->set_userdata(array('logged_in' => true));		 
			$_SESSION['admin_login']['logged_in'] = true;
