...
<title>運営会社｜車検費用が驚きの3万円台から！とことん車検ナビで車検予約</title>
...
<link href="../css/iroha.css" rel="stylesheet" type="text/css"/>
<script type="text/javascript" src="file:///C|/Users/3002rs/Dropbox/【MIC_webソース共有】/とことん車検ナビ/public_html/js/common_userAgent.js"></script>
...
<div id="wrapper">
	...
	<!---▼運営会社--->
    	<div id="all_contents">
        	<!---▼パンくずリスト--->
            <ul id="breadcrumb">
      			<li><a href="http://www.tokoton-navi.com/">ホーム</a></li>
     			<li>> 運営会社</li>
			</ul>
            <br class="clear">
            <!---▲パンくずリスト--->
            ...
            <!---▽会社概要--->
            <div id="company_info">
            <h3>「とことん車検ナビ」は株式会社マーケティングインフォメーションコミュニティが運営しています。</h3>
            	<table cellspacing="0" cellpadding="0" class="company_table">
      				<tr>
        				<td class="left">商号</td>
        				<td>株式会社 マーケティングインフォメーションコミュニティ（略称MIC）</td>
      				</tr>
      				...
      				<tr>
        				...
        				<td>神奈川県横浜市都筑区仲町台1-27-20 プラザ仲町台<br />
          					TEL：045-943-7281（代表）<br />FAX：045-943-7280</td>
      				</tr>
...
<!--▼section-->
    ...
    <section>
        <div class="title03">
	  	...
	  	<div class="about_us">
			<ul>
				<li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/useinfo.html"><span>車検ナビとは</span></a></li>
				<li class="about_us_left"><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/faq.html"><span>よくある質問</span></a></li>
			</ul>
            <ul>
            	<li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/rules.html">利用規約</a></li>
				<li class="about_us_left"><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/privacy.html"><span>プライバシー</span></a></li>
			</ul>
            <ul>
				<li><a href="https://<?= $_SERVER['HTTP_HOST'] ?>/inquiry.html"><span>お問合せ</span></a></li>
                <li class="about_us_left"><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/company.html"><span>運営会社</span></a></li>
			</ul>
            <ul>
    ...
    <section>
        <div class="footer_nav">
			<ul>
				<li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/sp/"><button type="button" name="" value="" class="footer_btn">HOME</button></a></li>
				<li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/search_top/"><button type="button" name="" value="" class="footer_btn">車検を探す</button></a></li>
                <li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/sitemap.html"><button type="button" name="" value="" class="footer_btn">サイトマップ</button></a></li>
			</ul>
...
<div id="modal">
	...
	<h2>■店舗検索</h2>
	<ul>
		<li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/search_top/">車検を探す</a></li>
	</ul>
	<h2>■お役立ちコンテンツ</h2>
	<ul>
		<li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/knowledge_1.php">車検のいろは</a></li>
		<li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/search/option_08/">クレジットカード取扱店</a></li>
	...
	<ul>
		...
		<li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/faq.html">よくある質問</a></li>
        <li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/rules.html">利用規約</a></li>
        <li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/privacy.html">プライバシーポリシー</a></li>
        <li><a href="https://<?= $_SERVER['HTTP_HOST'] ?>/inquiry.html">お問合せ</a></li>
