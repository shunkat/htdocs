...
$resbj = "お問合せいただき有難うございました";

// 必須入力項目を設定する(する=1, しない=0)
$esse = 1;

// 必須入力項目(入力フォームで指定したname)
$eles = array('ご氏名','email','郵便番号','住所','電話番号','お問い合わせ内容');
...
$rebody="━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n";
$rebody.="本メールは".$today[year]."年".$today[mon]."月".$today[mday]."日、メールにてお問い合わせいただきましたお客様に\n";
$rebody.="対してお送りしております。\n\n";
...
$rebody.=$_REQUEST['ご氏名']." 様\n\n";

$rebody.="この度は「とことん車検ナビ」にお問い合わせいただき、誠にありがとうございます。\n";

$rebody.="確認次第、担当者よりご連絡をさせていただきますので、\nいましばらくお待ちください。\n\n";
...
<?php htmlFooter(); } if(($jpage == 0 && $sendm == 1) || ($jpage == 0 && ($chmail == 0 && $sendm == 0))) { htmlHeader(); ?>
	<h3>お問い合わせ完了</h3>
      <div id="fin_box">
	  	<p id="sanks">お問い合わせありがとうございました。</p>
	  	<p id="notice">※回答には多少お時間をいただく場合がございます。ご了承ください。</p></div>
...
<div id="container">
  <div id="header">
    ...
    <h1>とことん車検ナビは信頼できる全国の車検ショップの車検、お得情報をご紹介。全店舗とことん24対応</h1>
    <br class="clear" />
  </div>
  <div id="content">
    <h2 id="inquiry_confirm">お問い合わせフォーム</h2>
    <div id="inquiry_box">
		<h3>お問い合わせフォーム</h3>
情報を送信中です。
